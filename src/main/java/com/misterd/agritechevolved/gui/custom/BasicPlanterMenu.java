...
public class BasicPlanterMenu extends AbstractContainerMenu {
        ...
        if (index < 36) {
            if (this.blockEntity.isValidPlant(sourceStack)) {
                if (this.blockEntity.inventory.getStackInSlot(0).isEmpty()) {
                    ...
                    if (!existingSoil.isEmpty() && !this.blockEntity.isValidPlantSoilCombination(sourceStack, existingSoil)) return ItemStack.EMPTY;
                ...
                if (!existingPlant.isEmpty() && !this.blockEntity.isValidPlantSoilCombination(existingPlant, sourceStack)) return ItemStack.EMPTY;
    ...
    public boolean stillValid(Player player) {
        ...
        return block instanceof PlanterBlock && stillValid(ContainerLevelAccess.create(this.level, this.blockEntity.getBlockPos()), player, block);
    }
