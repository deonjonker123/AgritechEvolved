...
public class FertilizerSpreaderScreen extends AbstractContainerScreen<FertilizerSpreaderMenu> {
    ...
    public FertilizerSpreaderScreen(FertilizerSpreaderMenu menu, Inventory playerInventory, Component title) {
