...
public class ATEItemTagProvider extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(ATETags.Items.BASIC_PLANTER_ITEMS)
                ...
                .add(ATEBlocks.TERRACOTTA_PLANTER.asItem())
                .add(ATEBlocks.BLACK_TERRACOTTA_PLANTER.asItem())
                .add(ATEBlocks.BLUE_TERRACOTTA_PLANTER.asItem())
                .add(ATEBlocks.BROWN_TERRACOTTA_PLANTER.asItem())
                .add(ATEBlocks.CYAN_TERRACOTTA_PLANTER.asItem())
                .add(ATEBlocks.GRAY_TERRACOTTA_PLANTER.asItem())
                .add(ATEBlocks.GREEN_TERRACOTTA_PLANTER.asItem())
                .add(ATEBlocks.LIGHT_BLUE_TERRACOTTA_PLANTER.asItem())
                .add(ATEBlocks.LIGHT_GRAY_TERRACOTTA_PLANTER.asItem())
                .add(ATEBlocks.LIME_TERRACOTTA_PLANTER.asItem())
                .add(ATEBlocks.MAGENTA_TERRACOTTA_PLANTER.asItem())
                .add(ATEBlocks.ORANGE_TERRACOTTA_PLANTER.asItem())
                .add(ATEBlocks.PINK_TERRACOTTA_PLANTER.asItem())
                .add(ATEBlocks.PURPLE_TERRACOTTA_PLANTER.asItem())
                .add(ATEBlocks.RED_TERRACOTTA_PLANTER.asItem())
                .add(ATEBlocks.WHITE_TERRACOTTA_PLANTER.asItem())
                .add(ATEBlocks.YELLOW_TERRACOTTA_PLANTER.asItem());;
