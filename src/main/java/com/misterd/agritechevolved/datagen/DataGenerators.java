...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent.Client event) {
        ...
        BlockTagsProvider blockTagsProvider = new ATEBlockTagProvider(packOutput, worldLookup);
        generator.addProvider(true, blockTagsProvider);

        generator.addProvider(true, new ATEModelProvider(packOutput));
        generator.addProvider(true, new ATEItemTagProvider(packOutput, worldLookup));
    }
